...
class Element(Node):
    ...
    @overload
    def __getitem__(self, key: slice[int | None, int | None, int | None]) -> list[Node]: ...
    @overload
    def __setitem__(self, key: str, item: Any) -> None: ...
    @overload
    def __setitem__(self, key: int, item: Node) -> None: ...
    @overload
    def __setitem__(self, key: slice[int | None, int | None, int | None], item: Iterable[Node]) -> None: ...
    def __delitem__(self, key: str | int | slice[int | None, int | None, int | None]) -> None: ...

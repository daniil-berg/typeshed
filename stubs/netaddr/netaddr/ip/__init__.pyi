from _typeshed import ConvertibleToInt, IndexSlice, Unused
...
class IPListMixin:
    ...
    @overload
    def __getitem__(self, index: IndexSlice) -> Iterator[IPAddress]: ...
    @overload
    def __getitem__(self, index: SupportsIndex | IndexSlice) -> IPAddress | Iterator[IPAddress]: ...

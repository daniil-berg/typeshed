from _typeshed import IndexSlice
...
class BaseContainer(Sequence[_T]):
    ...
    @overload
    def __getitem__(self, key: IndexSlice) -> list[_T]: ...
...
class RepeatedScalarFieldContainer(BaseContainer[_ScalarV]):
    ...
    @overload
    def __setitem__(self, key: slice[int | None, int | None, int | None], value: Iterable[_ScalarV]) -> None: ...
    def __delitem__(self, key: int | slice[int | None, int | None, int | None]) -> None: ...

import sqlite3
import sys
from _typeshed import IndexSlice, ReadableBuffer, StrOrBytesPath, SupportsLenAndGetItem, Unused
...
class Row:
    ...
    @overload
    def __getitem__(self, key: slice[int | None, int | None, int | None], /) -> tuple[Any, ...]: ...
...
if sys.version_info >= (3, 11):
    ...
    class Blob:
        ...
        def __getitem__(self, key: SupportsIndex | IndexSlice, /) -> int: ...
        def __setitem__(self, key: SupportsIndex | IndexSlice, value: int, /) -> None: ...

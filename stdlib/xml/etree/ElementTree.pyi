...
from _typeshed import FileDescriptorOrPath, IndexSlice, ReadableBuffer, SupportsRead, SupportsWrite
...
class Element:
    ...
    @overload
    def __getitem__(self, key: IndexSlice, /) -> list[Element]: ...
    ...
    @overload
    def __setitem__(self, key: IndexSlice, value: Iterable[Element], /) -> None: ...

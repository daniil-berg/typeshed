...
class SubPattern:
    ...
    def __getitem__(self, index: int | slice[int | None, int | None, int | None]) -> SubPattern | _CodeType: ...
    def __setitem__(self, index: int | slice[int | None, int | None, int | None], code: _CodeType) -> None: ...

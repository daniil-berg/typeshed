...
class mmap(Iterable[int], Sized):
    ...
    @overload
    def __getitem__(self, key: slice[int | None, int | None, int | None], /) -> bytes: ...
    def __delitem__(self, key: int | slice[int | None, int | None, int | None], /) -> NoReturn: ...
    @overload
    def __setitem__(self, key: int, value: int, /) -> None: ...
    @overload
    def __setitem__(self, key: slice[int | None, int | None, int | None], value: ReadableBuffer, /) -> None: ...

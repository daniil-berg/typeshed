...
class Sequence(Collection[_T_co], Reversible[_T_co]):
    ...
    @overload
    @abstractmethod
    def __getitem__(self, index: slice[int | None, int | None, int | None]) -> Sequence[_T_co]: ...
    # Mixin methods
...
class MutableSequence(Sequence[_T]):
    ...
    @overload
    @abstractmethod
    def __getitem__(self, index: slice[int | None, int | None, int | None]) -> MutableSequence[_T]: ...
    @overload
    @abstractmethod
    def __setitem__(self, index: int, value: _T) -> None: ...
    @overload
    @abstractmethod
    def __setitem__(self, index: slice[int | None, int | None, int | None], value: Iterable[_T]) -> None: ...
    @overload
    @abstractmethod

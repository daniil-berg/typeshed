...
import sys
import threading
from _typeshed import IndexSlice, SupportsKeysAndGetItem, SupportsRichComparison, SupportsRichComparisonT
...
class BaseListProxy(BaseProxy, MutableSequence[_T]):
    ...
    @overload
    def __setitem__(self, s: IndexSlice, o: Iterable[_T], /) -> None: ...

...
class SynchronizedArray(SynchronizedBase[ctypes.Array[_SimpleCData[_T]]], Generic[_T]):
    ...
    @overload
    def __getitem__(self, i: slice[int | None, int | None, int | None]) -> list[_T]: ...
    @overload
    def __getitem__(self, i: int) -> _T: ...
    @overload
    def __setitem__(self, i: slice[int | None, int | None, int | None], value: Iterable[_T]) -> None: ...
    @overload
...
class SynchronizedString(SynchronizedArray[bytes]):
    ...
    def __getitem__(self, i: slice[int | None, int | None, int | None]) -> bytes: ...
    @overload
    def __getitem__(self, i: int) -> bytes: ...
    @overload  # type: ignore[override]
    def __setitem__(self, i: slice[int | None, int | None, int | None], value: bytes) -> None: ...
    @overload
